...
Technical guide to run and deploy this Web AI Assistant instance. For product overview, see [README.md](README.md).
...
copy .env.example .env     # set GEMINI_API_KEY or other key
